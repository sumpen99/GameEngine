        ...
        while(i<segCount-1){
            ...
            for(short c = startCode;c<endCode;c++){
                if(idRangeOffset != 0){
                    ...
                    //IOHandler.printString("index (c): %d value glyphindex: %d ".formatted(c,glyphIndex));
                    format4.glyphIndexMap.addNewItem("%d".formatted(c),glyphIndex,ENTRIE_TTF_GLYPHINDEX);
                }
            }
            i++;
        }
